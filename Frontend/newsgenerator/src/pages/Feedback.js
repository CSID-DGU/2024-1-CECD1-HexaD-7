      ...
      <MainBox>
        ...
        <form onSubmit={handleSubmit} style={{display:"grid", gridTemplateColumns:"1fr 1fr"}}>
          <div style={{minWidth:"100%", minHeight:"100%"}}>
            <div style={{display:"flex", flexDirection:"column", justifyContent:"center", margin: "3vw", boxSizing:"border-box"}}>
              <TitleInput ref={titleInputRef} placeholder="기사 제목을 입력하세요" required />
              <ContentInput ref={draftInputRef} placeholder="기사 초안을 입력하세요" required />
            </div>
          </div>
